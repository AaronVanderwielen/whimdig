function initSchema(m) {
	...
	//var tagGlyph = {
	//	values: 'music beer celebration person_running tags group cutlery dog playing_dices book gamepad soccer_ball birthday_cake film'.split(' '),
	//	message: valMsg.enum
	//};
	...
	var tagSchema = new m.Schema({
		glyph: { type: String, required: valMsg.required },
	...
	eventSchema.pre('validate', function (next) {
		if (this.name.length > 60) {
			this.invalidate('name', 'Name needs to be less than 60 characters');
		}
		if (this.desc.length > 600) {
			this.invalidate('desc', 'Description needs to be less than 600 characters');
		}
