			...
			actions: {
				get: {
					...
					span: {
						authenticate: true,
						method: function (req, res) {
							bl.getAllEventsForSpan(req.query.span, req.query.filters, req.session.user.facebook_id, function (response) {
								res.json(response);
							});
						}
					},
				...
				post: {
					...
					update: {
						authenticate: true,
						method: function (req, res) {
							bl.updateEvent(req.body, req.session.user._id, function (response) {
								res.json(response);
							});
						}
					},
