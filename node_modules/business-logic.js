var BusinessLogic = function (Mongo, Https, underscore, facebook) {
	...
	this.getAllEventsForSpan = function (span, filters, fbId, callback) {
	...
	this.updateEvent = function (eventData, userId, callback) {
		var response = new jsonResponse(true, null),
			val;
				...
				if (response.success) {
					...
					if (val.success) {
						var id = eventData._id,
							query = { _id: new ObjectID(eventData._id), created_by: new ObjectID(userId) };
