var BusinessLogic = function (opts) {
	var bl = this,
        ...
        googleBrowserApiKey = 'AIzaSyB9EARriTjyHo7LupKAHvazcG245a04c54',
        // PROD : AIzaSyDBVBsIxFaRG2mIdQF7uZQ7I4ca_jAJ8mQ
        // TEST : AIzaSyB9EARriTjyHo7LupKAHvazcG245a04c54
        googleServerApiKey = 'AIzaSyB9EARriTjyHo7LupKAHvazcG245a04c54',
		db = opts.database,
	...
	this.importEventsCsv = function (data, callback) {
		...
		for (var d in data) {
			...
			if (eventData.desc.length > 600) {
				eventData.desc = eventData.desc.substring(0, 597) + "...";
			}
